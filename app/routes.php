...
$app->group('', function () use ($namespace) {
    ...
    $this->post('/recognizers/{id}/subjects', "$namespace\\RecognizerController:addSubjects");
    $this->delete('/recognizers/{id}/subjects/{sId}', "$namespace\\SubjectController:deleteRecognizerSubject");
    // Recognizer
